...
public class JavaNavigationServiceImpl implements JavaNavigationService {
    ...
    @Override
    public Promise<OpenDeclarationDescriptor> findDeclaration(String fqn, int offset) {
        String url =
    ...
    @Override
    public Promise<List<JarEntry>> getLibraryChildren(int libId) {
    ...
    @Override
    public Promise<List<JarEntry>> getChildren(int libId, Path path) {
    ...
    @Override
    public Promise<JarEntry> getEntry(int libId, String path) {
        String url =
    ...
    @Override
    public Promise<ClassContent> getContent(int libId, Path path) {
    ...
    @Override
    public Promise<ClassContent> getContent(String fqn) {
        String url = appContext.getDevMachine().getWsAgentBaseUrl() + "/java/navigation/contentbyfqn?projectpath=" + project.toString() + "&fqn=" + fqn;
        return requestFactory.createGetRequest(url).send(unmarshallerFactory.newUnmarshaller(ClassContent.class));
    }

    @Override
    public Promise<ImplementationsDescriptorDTO> getImplementations(String fqn, int offset) {
    ...
    @Override
    public Promise<CompilationUnit> getCompilationUnit(String fqn, boolean showInherited) {
    ...
    @Override
    public Promise<List<MethodParameters>> getMethodParametersHints(String fqn, int offset, int lineStartOffset) {
        String url = appContext.getDevMachine().getWsAgentBaseUrl() + "/java/navigation/parameters" +
