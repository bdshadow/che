...
/**
 * Helps to deal with docker container labels.
 *
...
public final class Labels {
    ...
    private static final String SERVER_LABEL_PREFIX       = LABEL_PREFIX + "server.";
    private static final String SERVER_PORT_LABEL_FMT     = SERVER_LABEL_PREFIX + "%s.port";
    private static final String SERVER_PROTOCOL_LABEL_FMT = SERVER_LABEL_PREFIX + "%s.protocol";
    private static final String SERVER_PATH_LABEL_FMT     = SERVER_LABEL_PREFIX + "%s.path";
    ...
    public static class Deserializer {
        ...
        public Map<String, ServerConfig> servers() {
            ...
            for (Map.Entry<String, String> entry : labels.entrySet()) {
                ...
                if (label.startsWith(SERVER_LABEL_PREFIX)) {
                    // ref.(port|protocol|path)
                    String ref = label.substring(SERVER_LABEL_PREFIX.length(), label.lastIndexOf('.'));
